...
import { d as defineCommand, c as cwdArgs, b as legacyRootDirArgs, n as nuxiPkg, a as logger } from '../shared/nuxi.BVSKcfmX.mjs';
import clipboard from './index5.mjs';
import { t as tryResolveNuxt, c as createJiti } from '../shared/nuxi.jHNMu6i2.mjs';
import { d as detectPackageManager } from '../shared/nuxi.u_uB65ir.mjs';
import { r as readPackageJSON } from '../shared/nuxi.DfYkt6zx.mjs';
import { s as splitByCase } from '../shared/nuxi.BgENdoyd.mjs';
...
`;
    ...
    const copied = await clipboard.write(infoStr).then(() => true).catch(() => false);
